...
\paragraph{Dataset} Prepared cells were imaged using a Zeiss confocal microscope using a 63x/1.4NA oil immersion lens. We will use the lsm file in the folder \directory{4 cargo relocation} which have the following channels:
...
\begin{enumerate}
    \item Open the image \directory{4 cargo relocation/Zeiss1344.lsm}. A windows pop up asking if the image is part of a sequence. Click on the \menu{Leave} button to not collate the files.
    ...
    \begin{enumerate}
        ...
        \endnote{filter radius:2px, threshold 1-255, smooth:, clear:}. 
