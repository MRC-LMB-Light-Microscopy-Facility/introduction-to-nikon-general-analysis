...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Create a mask for the cells using the Golgi marker (Ch2-T1) channel using \menu{Preprocessing > Convolution > Gaussian Filter} and \menu{Segmentation>Threshold} \endnote{median filter:2px, threshold 1-255, smooth:, clear:}. Note that the image bit depth changed to 32-bit after filtering.
